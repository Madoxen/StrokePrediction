...
value_mapper_dict = {
    'gender': {'Female': 0, 'Male': 1, 'Other': 2}, # i think we should drop the other (one occurrence), or classify "other" as Female
    'ever_married': {'No': 0, 'Yes': 1},
    'work_type': {'Private': 3, 'Self-employed': 4, 'children': 0, 'Govt_job': 2, 'Never_worked': 1}, # order is from frequency, values are my (Bartek) suggestions
    'Residence_type': {'Urban': 0, 'Rural': 1},
    'smoking_status': {'never smoked':0, 'Unknown':1, 'formerly smoked':2, 'smokes':3}, # shouldn't 'unknown' be dropped or assigned to most frequent? (possible positive corelation between this one and 'children' in work type)
}
